...
class RentersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create renter" do
    assert_difference('Renter.count') do
      post renters_url, params: { renter: { address: @renter.address, agency_name: @renter.agency_name, price: @renter.price, title: @renter.title } }
    end
  ...
  test "should update renter" do
    patch renter_url(@renter), params: { renter: { address: @renter.address, agency_name: @renter.agency_name, price: @renter.price, title: @renter.title } }
